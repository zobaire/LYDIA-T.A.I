...
window.CodeDock = (() => {
  ...
  const lydiaTheme = EditorView.theme({
    '&': { color: '#1e2843', backgroundColor: 'transparent', height: '100%' },
    '.cm-content': { caretColor: '#0a8fa8', padding: '12px 0 80px', fontFamily: 'var(--mono)' },
    '.cm-cursor, .cm-dropCursor': { borderLeftColor: '#0a8fa8', boxShadow: '0 0 6px rgba(10,143,168,0.55)' },
    '&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, ::selection': { backgroundColor: 'rgba(59,110,245,0.22) !important' },
    '.cm-gutters': { backgroundColor: 'rgba(240,243,250,0.95)', color: '#8b94ad', border: 'none', borderRight: '1px solid rgba(59,110,245,0.10)' },
    '.cm-activeLine': { backgroundColor: 'rgba(59,110,245,0.05)' },
    '.cm-activeLineGutter': { backgroundColor: 'rgba(59,110,245,0.08)', color: '#3456c9' },
    '.cm-lineNumbers .cm-gutterElement': { minWidth: '34px', padding: '0 8px 0 12px' },
    '.cm-foldGutter .cm-gutterElement': { padding: '0 6px' },
    '.cm-matchingBracket': { backgroundColor: 'rgba(12,139,130,0.14)', outline: '1px solid rgba(12,139,130,0.5)', color: '#0a6f67' },
    '.cm-searchMatch': { backgroundColor: 'rgba(124,92,255,0.16)', outline: '1px solid #7c5cff' },
    '.cm-tooltip': { backgroundColor: '#ffffff', border: '1px solid rgba(59,110,245,0.24)', color: '#1e2843', borderRadius: '10px', fontFamily: 'var(--mono)', boxShadow: '0 12px 32px rgba(35,48,90,0.16)' },
    '.cm-tooltip-autocomplete ul li[aria-selected]': { backgroundColor: 'rgba(59,110,245,0.14)', color: '#1e2843' },
    '.cm-scroller': { fontFamily: 'var(--mono)', fontSize: '12.5px', lineHeight: '1.65' }
  }, { dark: false });

  const lydiaHighlight = HighlightStyle.define([
    { tag: tags.keyword, color: '#3456c9', fontWeight: '600' },
    { tag: [tags.name, tags.deleted, tags.character, tags.propertyName, tags.macroName], color: '#1e2843' },
    { tag: [tags.function(tags.variableName), tags.labelName], color: '#0a7f9c' },
    { tag: [tags.color, tags.constant(tags.name), tags.standard(tags.name)], color: '#0c8b82' },
    { tag: [tags.definition(tags.name), tags.separator], color: '#1e2843' },
    { tag: [tags.typeName, tags.className, tags.number, tags.changed, tags.annotation, tags.modifier, tags.self, tags.namespace], color: '#6b4de0' },
    { tag: [tags.operator, tags.operatorKeyword, tags.escape, tags.regexp, tags.link, tags.special(tags.string)], color: '#0a7f9c' },
    { tag: [tags.meta, tags.comment], color: '#8b94ad', fontStyle: 'italic' },
    { tag: tags.strong, fontWeight: 'bold' },
    { tag: tags.emphasis, fontStyle: 'italic' },
    { tag: tags.strikethrough, textDecoration: 'line-through' },
    { tag: tags.heading, fontWeight: 'bold', color: '#3456c9' },
    { tag: [tags.atom, tags.bool, tags.special(tags.variableName)], color: '#d6336c' },
    { tag: [tags.processingInstruction, tags.string, tags.inserted], color: '#0c8b82' },
    { tag: tags.invalid, color: '#d64550' }
  ]);
